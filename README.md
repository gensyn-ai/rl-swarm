...
A quick overview of the main directories in this repository:

- `rlswarm/` — core library modules for distributed RL execution.
- `examples/` — sample scripts demonstrating how to use RL-Swarm in practice.
- `tests/` — basic test suite for validating components.
- `configs/` — configuration files for experiments and training runs.

This overview helps new contributors navigate the codebase more easily.
